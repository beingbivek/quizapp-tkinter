...
Label(topframemain, text="Quiz App", font=("Arial", 12), padx=20, pady=0, bg='#003366', fg='white').place(x=0, y=0)

welcomeframe = Frame(a, bd=2, relief="ridge", padx=0, pady=0, bg='#00509e')
welcomeframe.place(x=150, y=70, width=400, height=60)
Label(welcomeframe, text="Welcome to Quiz App", font=("Arial", 30, "bold"), bg='#00509e', fg='white').pack(pady=10, padx=10)
...
Button(frame, text="Login", command=admin_login, bg="#00509e", fg="white").place(x=100, y=190)

infotopframe = Frame(a, bd=2, relief="ridge", padx=0, pady=0, bg='#003366')
infotopframe.place(x=200, y=140, width=300, height=20)
Label(infotopframe, text="Admin Login", font=("Arial", 10), padx=15, pady=-2, bg='#003366', fg='white').place(x=0, y=0)

backframe = Frame(a, bd=2, relief="ridge", padx=0, pady=0)
backframe.place(x=450, y=140, width=50, height=20)
b1=Button(backframe, text="Back", command=open_login, bg="#00509e").place(x=-10, y=-8)

# Top buttons
Button(framemain, text="Register", command=open_registration, bg="#00509e", fg="white").place(x=500, y=30)
Button(framemain, text="Login", command=open_login, bg="#00509e", fg="white").place(x=600, y=30)
